...
<template>
  <div class="DateFieldWrapper">
    ...
    <DatePickerRoot id="date-field" granularity="day">
      <DatePickerField v-slot="{ segments }" class="DateField">
      ...
      <DatePickerContent align="end" :side-offset="16" class="PopoverContent">
            ...
            >
              <DatePickerGridHead>
                <DatePickerGridRow class="CalendarGridRow">
                  <DatePickerHeadCell v-for="day in weekDays" :key="day" class="CalendarHeadCell">
                    {{ day }}
                  </DatePickerHeadCell>
                </DatePickerGridRow>
              </DatePickerGridHead>
